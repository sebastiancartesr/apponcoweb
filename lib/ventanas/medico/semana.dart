            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  color: Colors.blue[900],
                  onPressed: () {
                    Navigator.pushReplacementNamed(context, '/mesinfo');
                  },
                ),
              ),
            ],
...
class Semanainfo extends StatefulWidget {
  Semanainfo({Key key}) : super(key: key);

  _SemanainfoState createState() => _SemanainfoState();
}

class _SemanainfoState extends State<Semanainfo> {
  DateTime _hoy = DateTime.now();
  DateTime _fin = DateTime.now().subtract(Duration(days: 7));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text("Informacion de la ultima semana",
            ...
            child: GridView(
              ...
              children: <Widget>[
                ...
                Card(
                  ...
                  child: Scaffold(
                    appBar: AppBar(
                      title: Text("Pacientes sin registros esta semana"),

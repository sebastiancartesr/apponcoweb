...
class VerTrabajadores extends StatelessWidget {
  final Usuario _usuario = new Usuario();
    ...
    final response = await http.post("http://192.168.1.108/demo1/vertrabajadores.php", body:{
    }); 
...
class _DetailState extends State<Detail> {
  ...
  String _direccion;
    ...
    return TextFormField(
      ...
      final response = await http.post("http://192.168.1.108/demo1/editardatostrabajador.php", body:{

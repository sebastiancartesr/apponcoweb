...
//--------------------------------------------------------------------------
    void addTrabajador(){
      var url = "http://192.168.42.49/demo1/creartrabajador.php";
      http.post(url, body: {
...
//----------------------------------------------------------------------------
  Future <List> getidrol() async{
    final response = await http.post("http://192.168.42.49/demo1/idrol.php", body:{
...
//-----idpersona agregada no se tiene
   ...
   Future <List> getid() async{
    final response = await http.post("http://192.168.42.49/demo1/buscarid.php", body:{
      "Correo":_email,
    });
    var datauser = json.decode(response.body);
...
//----------------------------------------------------------------------------
    ...
    void addMedico() {
      var url = "http://192.168.42.49/demo1/agregarpersona.php";
  ...
  //validar rut
      ...
      final response = await http.post("http://192.168.42.49/demo1/verdatospersona.php", body:{
      "Correo":_email,
      "Rut":_rut,
      });
      var datauser = json.decode(response.body);
